...
export interface SheetData { sheetId: string; assessmentId: string; assessmentNumber: string; assessmentYear: number; grade: number; subject: Subject; unitName: string; studentName?: string; className?: string; timeMode: 'PARTIAL'|'FULL'; questionCount: number }
